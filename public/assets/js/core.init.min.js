...
function themerex_ready_actions() {
  "use strict";
  window.themerex_skin_ready_actions && themerex_skin_ready_actions(),
    ...
    jQuery(".widget_calendar").on(
      ...
      function (e) {
        var t = jQuery(this).parents(".wp-calendar"),
          s = jQuery(this).data("month"),
          i = jQuery(this).data("year"),
          r = jQuery(this).data("type");
        return (
          jQuery
              ...
              "" === s.error &&
                t.parent().fadeOut(200, function () {
                  jQuery(this).find(".wp-calendar").remove(),
                    jQuery(this).append(s.data).fadeIn(200);
                });
            }),
          e.preventDefault(),
          !1
    ...
    jQuery(".menu_main_responsive_button").click(function (e) {
      return (
        jQuery(".menu_main_responsive").slideToggle(), e.preventDefault(), !1
      );
    }),
    jQuery(".menu_main_wrap .menu_main_responsive li a").click(function (e) {
      if (
        (jQuery("body").hasClass("responsive_menu") &&
          ...
          (jQuery(this).siblings("ul:visible").length > 0
            ? jQuery(this)
                .siblings("ul")
                .slideUp()
                .parent()
    ...
    THEMEREX_GLOBALS.menu_slider &&
      jQuery("#menu_main").spasticNav({ color: THEMEREX_GLOBALS.menu_color }),
    "no" != THEMEREX_GLOBALS.toc_menu && themerex_build_page_toc(),
    jQuery("#toc, .menu_main_wrap ul li, .menu_user_wrap ul#menu_user li").on(
      ...
      function (e) {
        ...
        if (void 0 !== t) {
          var s = t.indexOf("#");
          if (!(s < 0 || 1 == t.length) && jQuery(t.substr(s)).length > 0) {
            var i = window.location.href,
              r = i.indexOf("#");
            r > 0 && (i = i.substring(0, r));
            var a = 0 == s;
            if ((a || (a = i == t.substring(0, s)), a))
              return (
                themerex_document_animate_to(t.substr(s)),
                themerex_document_set_location(0 == s ? i + t : t),
                e.preventDefault(),
                !1
              );
          }
    ...
    jQuery("#viewmore_link").click(function (e) {
      return (
        THEMEREX_GLOBALS.viewmore_busy ||
          ...
          (THEMEREX_GLOBALS.viewmore_busy = !0),
          jQuery
            .post(THEMEREX_GLOBALS.ajax_url, {
            ...
            .done(function (e) {
              ...
              if (
                ...
                s.find(".isotope_wrap").length > 0 &&
                  (s = s.find(".isotope_wrap").eq(0)),
                  s.hasClass("isotope_wrap")
                    ? (s.data("last-width", 0).append(t.data),
                      (THEMEREX_GLOBALS.isotope_init_counter = 0),
                      themerex_init_appended_isotope(s, t.filters))
    ...
    jQuery(
      ".woocommerce .mode_buttons a,.woocommerce-page .mode_buttons a"
    ).click(function (e) {
      var t = jQuery(this).hasClass("woocommerce_thumbs") ? "thumbs" : "list";
      return (
        jQuery.cookie("themerex_shop_mode", t, { expires: 365, path: "/" }),
    ...
    jQuery("body").bind("added_to_cart", function () {
      ...
      null != e && jQuery(".cart_button .cart_total").text(e);
    }),
    jQuery(".menu_user_wrap .popup_link")
      .addClass("inited")
      .click(function (e) {
    ...
    jQuery(".bookmarks_add").click(function (e) {
      var t = window.document.title.split("|")[0],
        ...
        i = jQuery.cookie("themerex_bookmarks"),
        r = !1;
      if (i) {
        i = JSON.parse(i);
      ...
      if (r)
        themerex_message_warning(
          THEMEREX_GLOBALS.strings.bookmark_exists,
          THEMEREX_GLOBALS.strings.bookmark_add
        );
      else
        var n = themerex_message_dialog(
          ...
          function (e, r) {
            1 == e &&
              ((t = n.find("#bookmark_title").val()),
              i.push({ title: t, url: s }),
              ...
              jQuery.cookie("themerex_bookmarks", JSON.stringify(i), {
                expires: 365,
                path: "/",
              }),
              setTimeout(function () {
    ...
    jQuery(".bookmarks_list").on("click", ".bookmarks_delete", function (e) {
      var t = jQuery(this).parent().index(),
        s = jQuery.cookie("themerex_bookmarks");
      return (
        s &&
          ((s = JSON.parse(s)).splice(t, 1),
          jQuery.cookie("themerex_bookmarks", JSON.stringify(s), {
            expires: 365,
            path: "/",
          })),
    ...
    window.themerex_init_hidden_elements &&
...
function themerex_scroll_actions() {
  ...
  if (
    (0 == THEMEREX_GLOBALS.top_panel_height &&
      (THEMEREX_GLOBALS.top_panel_height = jQuery(".top_panel_wrap").height()),
    window.themerex_skin_scroll_actions && themerex_skin_scroll_actions(),
    e > THEMEREX_GLOBALS.top_panel_height
      ? t.addClass("show")
      : t.removeClass("show"),
    !jQuery("body").hasClass("responsive_menu") && THEMEREX_GLOBALS.menu_fixed)
  ) {
    var s = 0;
    jQuery(".top_panel_below .slider_wrap").length > 0 &&
      (s = jQuery(".top_panel_below .slider_wrap").height()) < 10 &&
      (s = jQuery(".slider_wrap").hasClass(".slider_fullscreen")
        ? jQuery(window).height()
        : THEMEREX_GLOBALS.slider_height),
      e <= s + THEMEREX_GLOBALS.top_panel_height
  ...
  jQuery("#toc .toc_item").each(function () {
    ...
    if (!(s < 0 || 1 == t.length)) {
      ...
      if ((a || (a = i == href.substring(0, s)), a)) {
        var n = jQuery(t).offset().top,
          o = jQuery(this).next().find("a").attr("href"),
          _ = o ? jQuery(o).offset().top : 1e6;
        n < e + 0.8 * jQuery(window).height() &&
        e + THEMEREX_GLOBALS.top_panel_height < _
...
function themerex_parallax_scroll() {
  jQuery(".sc_parallax").each(function () {
    var e = jQuery(window).height(),
      ...
      s = Math.max(jQuery(this).offset().top, e);
    if (s <= t + e) {
      var i = Number(jQuery(this).data("parallax-speed")),
        r = jQuery(this).data("parallax-x-pos"),
        a = Math.round((s - t - e) * i + (i < 0 ? e * i : 0));
      jQuery(this)
        .find(".sc_parallax_content")
        .css("backgroundPosition", r + " " + a + "px"),
        jQuery(this)
...
function themerex_resize_actions() {
  "use strict";
  window.themerex_skin_resize_actions && themerex_skin_resize_actions(),
...
function themerex_responsive_menu() {
  themerex_is_responsive_need(THEMEREX_GLOBALS.menu_responsive)
    ? jQuery("body").hasClass("responsive_menu") ||
      (jQuery("body")
        .removeClass("top_panel_fixed")
        .addClass("responsive_menu"),
      jQuery("body").hasClass("menu_relayout") &&
        jQuery("body")
          .removeClass("menu_relayout menu_left")
          .addClass("menu_right"),
      jQuery("ul.menu_main_nav").hasClass("inited") &&
    ...
    : (jQuery("body").hasClass("responsive_menu") &&
      ...
      themerex_is_responsive_need(THEMEREX_GLOBALS.menu_relayout)
        ? jQuery("body").hasClass("menu_right") &&
          jQuery("body")
        ...
        : jQuery("body").hasClass("menu_relayout") &&
          jQuery("body")
            .removeClass("menu_relayout menu_left")
            .addClass("menu_right")),
    jQuery(".menu_main_wrap").hasClass("menu_show") ||
...
function themerex_video_dimensions() {
  jQuery(".sc_video_frame").each(function () {
    ...
    if (s && i) {
      ...
      var a = Math.min(r ? 1e4 : s, e.parents("div,article").width()),
        n = Math.round(r ? a / t : (a / s) * i);
      parseInt(e.attr("data-last-width")) != a &&
        (r ? e.height(n) : e.css({ width: a + "px", height: n + "px" }),
    ...
    jQuery("video.sc_video,video.wp-video-shortcode").each(function () {
      ...
      t = 2 != t.length || 0 == t[0] || 0 == t[1] ? 16 / 9 : t[0] / t[1];
      var s = e.parents(".mejs-video"),
        i = e.parents(".sc_video_frame"),
        r = i.length > 0 ? i.data("width") : e.data("width"),
        a = i.length > 0 ? i.data("height") : e.data("height");
      if (!r || !a) {
      ...
      var o = Math.round(
          s.length > 0
            ? Math.min(n ? 1e4 : r, s.parents("div,article").width())
            : e.width()
        ),
        _ = Math.round(n ? o / t : (o / r) * a);
      parseInt(e.attr("data-last-width")) != o &&
        (s.length > 0 && mejs && themerex_set_mejs_player_dimensions(e, o, _),
        n
          ? e.height(_)
          : e
              .attr({ width: o, height: _ })
              .css({ width: o + "px", height: _ + "px" }),
        e.attr("data-last-width", o));
    }),
    jQuery("video.sc_video_bg").each(function () {
      ...
      t = 2 != t.length || 0 == t[0] || 0 == t[1] ? 16 / 9 : t[0] / t[1];
      var s = e.parents(".mejs-video"),
        i = s.length > 0 ? s.parent() : e.parent(),
        r = i.width(),
        a = i.height(),
        n = Math.ceil(a * t),
        o = Math.ceil(r / t);
      if (e.parents(".sc_parallax").length > 0) {
        var _ = jQuery(window).height(),
          ...
          u = Math.ceil(Math.abs((_ - a) * l));
        o < a + u && ((o = a + u), (n = Math.ceil(o * t)));
      }
      o < a && ((o = a), (n = Math.ceil(o * t))),
        n < r && ((n = r), (o = Math.ceil(n / t)));
      var d = Math.round((n - r) / 2),
        m = Math.round((o - a) / 2);
      parseInt(e.attr("data-last-width")) != n &&
        (s.length > 0
          ? (themerex_set_mejs_player_dimensions(e, n, o),
            s.css({ left: -d + "px", top: -m + "px" }))
          : e.css({ left: -d + "px", top: -m + "px" }),
        e
          .attr({ width: n, height: o, "data-last-width": n })
          .css({ width: n + "px", height: o + "px" }),
    ...
    jQuery("iframe").each(function () {
      ...
      var s = e.attr("width"),
        i = e.attr("height"),
        r = e.parents(".sc_video_frame");
      if (
        (r.length > 0 && ((s = r.data("width")), (i = r.data("height"))),
        s && i)
      ) {
        var a = "%" == ("" + s).substr(-1);
        (s = parseInt(s)), (i = parseInt(i));
        var n = r.length > 0 ? r.width() : e.width(),
          o = Math.round(a ? n / t : (n / s) * i);
        parseInt(e.attr("data-last-width")) != n &&
          e.css({ width: n + "px", height: o + "px" });
      }
    });
}
function themerex_resize_video_background() {
  ...
  if (!(e.length < 1))
    if (
      ...
      var t = e.find("video"),
        s = null != t.data("ratio") ? t.data("ratio").split(":") : [16, 9];
      s = 2 != s.length || 0 == s[0] || 0 == s[1] ? 16 / 9 : s[0] / s[1];
      var i = e.width(),
        r = e.height(),
        a = Math.ceil(r * s),
        n = Math.ceil(i / s);
      n < r && ((n = r), (a = Math.ceil(n * s))),
        a < i && ((a = i), (n = Math.ceil(a / s)));
      var o = Math.round((a - i) / 2),
        _ = Math.round((n - r) / 2);
      e.find(".mejs-container").length > 0
        ? (themerex_set_mejs_player_dimensions(e.find("video"), a, n),
          e.find(".mejs-container").css({ left: -o + "px", top: -_ + "px" }))
        : e.find("video").css({ left: -o + "px", top: -_ + "px" }),
        e
          .find("video")
          .attr({ width: a, height: n })
    ...
    for (var i in mejs.players)
      mejs.players[i].media.src == e.attr("src") &&
        (mejs.players[i].media.setVideoSize &&
          mejs.players[i].media.setVideoSize(t, s),
        mejs.players[i].setPlayerSize(t, s),
            ...
            onBeforeShow: function (e) {
              if (jQuery(this).parents("ul").length > 1) {
                var t = jQuery(window).width(),
                  s = jQuery(this).parents("ul").offset().left,
                  i = jQuery(this).parents("ul").outerWidth(),
                  r = jQuery(this).outerWidth();
                s + i + r > t - 20 && s - r > 0
                  ? jQuery(this).addClass("submenu_left")
                  : jQuery(this).removeClass("submenu_left");
              }
              THEMEREX_GLOBALS.css_animation &&
...
function themerex_build_page_toc() {
  ...
  var e = "",
    t = 0;
  jQuery('[id^="toc_"],.sc_anchor').each(function (s) {
    var i = jQuery(this),
      r = i.attr("id"),
      a = i.data("url"),
      n = i.data("icon");
...
function themerex_init_isotope() {
  ...
  jQuery(".isotope_wrap:not(.inited)").each(function () {
    ...
    !e && THEMEREX_GLOBALS.isotope_init_counter++ < 30
...
function themerex_init_appended_isotope(e, t) {
  ...
  if (!(e.parents(".sc_scroll_horizontal").length > 0))
    if (
      !themerex_check_images_complete(e) &&
      ...
      for (var i in t)
        0 == s.find('a[data-filter=".flt_' + i + '"]').length &&
          s.append(
      ...
      setTimeout(function () {
        e.isotope("appended", r),
          r.animate({ opacity: 1 }, 200, function () {
            jQuery(this).addClass("isotope_item_show");
          });
      }, 500);
    }
...
function themerex_init_post_formats() {
  ...
  if (
    ...
    jQuery(".isotope_wrap:not(.inited)").length > 0 &&
      ((THEMEREX_GLOBALS.isotope_init_counter = 0), themerex_init_isotope()),
    ...
    jQuery("a[href$='jpg'],a[href$='jpeg'],a[href$='png'],a[href$='gif']").attr(
      "rel",
      "prettyPhoto" + (THEMEREX_GLOBALS.popup_gallery ? "[slideshow]" : "")
    );
    var e = jQuery(
  ...
  jQuery(
    ...
    jQuery(".post_counters_likes:not(.inited)").length > 0 &&
      jQuery(".post_counters_likes:not(.inited)")
        ...
        .click(function (e) {
          var t = jQuery(this),
            s = t.hasClass("enabled") ? 1 : -1,
            i = t.data("postid"),
            r = Number(t.data("likes")) + s,
            a = themerex_get_cookie("themerex_likes");
          return (
            null == a && (a = ""),
            jQuery
              .post(THEMEREX_GLOBALS.ajax_url, {
              ...
              .done(function (e) {
                if ("" === JSON.parse(e).error) {
                  ...
                  t
                    ...
                    .html(r),
                    themerex_set_cookie("themerex_likes", a, 365);
...
function themerex_init_media_elements(e) {
  THEMEREX_GLOBALS.media_elements_enabled &&
    ...
    (window.mejs
      ? (void 0 !== window.mejs.MepDefaults &&
          (window.mejs.MepDefaults.enableAutosize = !1),
        void 0 !== window.mejs.MediaElementDefaults &&
...
function themerex_show_system_message() {
  THEMEREX_GLOBALS.system_message.message &&
    ("success" == THEMEREX_GLOBALS.system_message.status
      ? themerex_message_success(
          THEMEREX_GLOBALS.system_message.message,
          THEMEREX_GLOBALS.system_message.header
        )
      : "info" == THEMEREX_GLOBALS.system_message.status
      ? themerex_message_info(
          THEMEREX_GLOBALS.system_message.message,
          THEMEREX_GLOBALS.system_message.header
        )
      : ("error" != THEMEREX_GLOBALS.system_message.status &&
          "warning" != THEMEREX_GLOBALS.system_message.status) ||
        themerex_message_warning(
          THEMEREX_GLOBALS.system_message.message,
          THEMEREX_GLOBALS.system_message.header
        ));
...
function themerex_show_popup(e) {
  "none" == e.css("display") &&
    (THEMEREX_GLOBALS.css_animation
      ? e
          .show()
          .removeClass("animated fast " + THEMEREX_GLOBALS.menu_animation_out)
          .addClass("animated fast " + THEMEREX_GLOBALS.menu_animation_in)
      : e.slideDown());
}
function themerex_hide_popup(e) {
  "none" != e.css("display") &&
    (THEMEREX_GLOBALS.css_animation
      ? e
          .removeClass("animated fast " + THEMEREX_GLOBALS.menu_animation_in)
          .addClass("animated fast " + THEMEREX_GLOBALS.menu_animation_out)
          .delay(500)
          .hide()
      : e.fadeOut());
}
          ...
          0 == i.length && (i = e.siblings(".result")),
            ...
            "" === s.error
              ? (i
                  ...
                  .html(THEMEREX_GLOBALS.strings.login_success),
                setTimeout(function () {
                  location.reload();
                }, 3e3))
              : i
                  ...
                  .html(
                    THEMEREX_GLOBALS.strings.login_failed + "<br>" + s.error
                  ),
        ...
        .done(function (t) {
          ...
          0 == i.length && (i = e.siblings(".result")),
            ...
            "" === s.error
              ? (i
                  .addClass("sc_infobox sc_infobox_style_success")
                  .html(THEMEREX_GLOBALS.strings.registration_success),
                setTimeout(function () {
              ...
              : i
                  .addClass("sc_infobox sc_infobox_style_error")
                  .html(
                    THEMEREX_GLOBALS.strings.registration_failed + " " + s.error
                  ),
            i.fadeIn().delay(3e3).fadeOut();
        }),
    !1
...
//   var t = "include/sendmail.php";
  e.find("input").removeClass("error_fields_class");
  var s = !1,
    i = "custom" == e.data("formtype");
  return (
    i ||
      (s = themerex_form_validate(e, {
        error_message_show: !0,
        error_message_time: 4e3,
        error_message_class: "sc_infobox sc_infobox_style_error",
        error_fields_class: "error_fields_class",
        ...
        .done(function (t) {
          ...
          "" === s.error
            ...
            : i
                ...
                .html(THEMEREX_GLOBALS.strings.send_error + " " + s.error),
            i.fadeIn().delay(3e3).fadeOut();
        }),
    !s
  );
