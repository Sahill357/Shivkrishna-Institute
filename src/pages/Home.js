          ...
          <div className="content_wrap clearfix">
            ...
            <nav className="menu_main_nav_area">
              <ul id="menu_main" className="menu_main_nav">
                <li className="menu-item menu-item-has-children current-menu-ancestor current-menu-parent"><Link to="/">Home</Link>
                ...
                <thead>
                  <tr>
                    <th className="month_prev">
                      <a href="#" data-type="post,courses,tribe_events" data-year={2015} data-month={1} title="View posts for January 2015" />
                    </th>
